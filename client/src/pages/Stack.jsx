...
import { GiPillDrop, GiScales } from 'react-icons/gi';
import { FaCapsules, FaSave } from 'react-icons/fa';
      ...
      <Paper elevation={4} className={classes.paper}>
        <div className='flex items-center justify-between'>
          ...
          <Card className={`${classes.card} ${classes.card2} `}>
            <CardContent className={classes.cardContent}>
              <h3 className='text-gray-800 text-lg'>Choose your amount</h3>
              <p className='text-gray-600 text-sm'>within recomended dosages</p>
            </CardContent>
          </Card>

          <Card className={`${classes.card} ${classes.card3}`}>
            <CardContent className={classes.cardContent}>
              <h3 className='text-gray-800 text-lg'>Save your stack</h3>
              <p className='text-gray-600 text-sm'>
                check out other users stacks
              </p>
          ...
          <Card className={`${classes.card} ${classes.card4}`}>
            <CardContent className={classes.cardContent}>
              <h3 className='text-gray-800 text-lg'>
                We'll cap and bottle your stack
              </h3>
